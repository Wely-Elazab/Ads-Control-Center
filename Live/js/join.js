  ...
  var JOIN = {
    ...
    lines: {
      ar: [
        ...
        'لربط Google Ads — البريد الإلكتروني الذي تدخل به إلى Google Ads:',
        'رقم واتساب (اختياري):',
        '',
        'بإرسال هذا الطلب، أوافق على الانضمام إلى التجربة بصفتي مختبِراً للأداة وفق بند «برنامج التجربة» في شروط الاستخدام: {terms}'
      ],
      en: [
        'Name:',
        'Business name:',
